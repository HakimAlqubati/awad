...
class UnitPriceController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $unitPrice = UnitPrice::where('id', $id)->get();
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'unitPrice', 'products', 'units'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $orderPrice = UnitPrice::find($id);

        $orderPrice->price =    $request->price;


        $update =  $orderPrice->save();

        if ($update == 1) {
            $redirect = redirect()->back();

            return $redirect->with([
                'message'    => "Done updated order price with #" . $id . " ID ",
                'alert-type' => 'success',
            ]);
        }
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'units', 'products'));
    }
